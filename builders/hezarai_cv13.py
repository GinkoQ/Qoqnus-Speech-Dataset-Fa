"""
Standalone builder for hezarai_cv13 dataset.
Run from v2/: python builders/hezarai_cv13.py

Source: raw/hezarai_cv13/data/*.parquet
  columns : ['client_id', 'path', 'audio', 'sentence', 'up_votes', 'down_votes',
             'age', 'gender', 'accent', 'locale', 'segment', 'variant']
  audio   : AudioDecoder (_hf_encoded bytes, mp3)
  text    : sentence
  speaker : client_id col (dataset-provided) -> tagged "ds:<client_id>"
  splits  : test, train, validation

Smoke test: python builders/hezarai_cv13.py --smoke 5
"""
import os
...
SOURCE      = "hezarai_cv13"
RAW_DIR     = Path("raw/hezarai_cv13")
OUT_DIR     = Path("processed/hezarai_cv13")
SHARDS_DIR  = OUT_DIR / "_shards"
LOG_DIR     = Path("logs")
TEXT_COL    = "sentence"
SPEAKER_COL = "client_id"   # dataset-provided
TARGET_SR   = 16000
MIN_DUR     = 0.3
MAX_DUR     = 40.0
CLIP_AMP    = 0.999
