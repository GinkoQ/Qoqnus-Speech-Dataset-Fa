"""
Standalone builder for m522t dataset.
Run from v2/: python builders/m522t.py

Source: raw/m522t/data/*.parquet
  columns : ['audio', 'sentence']
  audio   : AudioDecoder (_hf_encoded bytes, wav)
  text    : sentence
  speaker : no speaker col -> gen:m522t_spk0000
  splits  : train only

Smoke test: python builders/m522t.py --smoke 5
"""
import os
...
SOURCE      = "m522t"
RAW_DIR     = Path("raw/m522t")
OUT_DIR     = Path("processed/m522t")
SHARDS_DIR  = OUT_DIR / "_shards"
LOG_DIR     = Path("logs")
TEXT_COL    = "sentence"
SPEAKER     = "gen:m522t_spk0000"
TARGET_SR   = 16000
MIN_DUR     = 0.3
MAX_DUR     = 40.0
CLIP_AMP    = 0.999
